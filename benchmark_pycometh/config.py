class ModuleConfig:
    def __init__(self):
        ...
        self.mock_bsseq_template_file_consistency_testing = (
            "/home/r933r/data/projects/nanopore/pycometh_benchmark/met_merged/{sample}_mock_bsseq_small/subset{iteration}.bedGraph"
        )
